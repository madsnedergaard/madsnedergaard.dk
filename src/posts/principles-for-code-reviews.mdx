...
Focus on what matters most when giving reviews. Not all nitpicks are worth pointing out, and the
...
- **Abstractions**
  ...
  Not everything has to be a reusable component or class after all, I'd rather see duplicate code
  than [too DRY code](https://www.contenthere.net/2014/09/too-dry-anti-pattern.html).
...
- When they improve the user experience
